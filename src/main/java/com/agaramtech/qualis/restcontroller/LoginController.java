...
//ALPD-6042--Added by vignesh(09-07-2025)--for Email Authentication.
@PostMapping(value = "/getAuthenticationModal")
public ResponseEntity<Object> getAuthenticationModal(@RequestBody Map<String, Object> inputMap) throws Exception {
	return loginService.getAuthenticationModal(inputMap);
}
